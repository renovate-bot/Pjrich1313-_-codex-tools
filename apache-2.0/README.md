# Apache 2.0 Codex Alternatives

Full pulls of Apache-2.0 licensed tools and adapters for the Codex ecosystem.

## Included

### 1. openai/codex-plugin-cc
- **License**: Apache-2.0
- **Purpose**: Use Codex from inside Claude Code (reviews + task delegation)
- **Path**: `apache-2.0/codex-plugin-cc/`
- **Upstream**: https://github.com/openai/codex-plugin-cc

### 2. agentclientprotocol/codex-acp
- **License**: Apache-2.0
- **Purpose**: ACP server that exposes Codex CLI to other clients/IDEs
